...
#ifndef STACK_MEMORY_MANAGER_H_
...
typedef struct
{
	...
	ion_stack_memory_size_t	size;		/**< The size of the segment, in bytes. */
	void	*next_front;	/**< The next free memory address of the front
				     stack. */
	void	*last_back;	/**< The last address use by the back stack. */
	ion_stack_memory_error_code_t	errcode;	/**< An error code variable that can be checked
